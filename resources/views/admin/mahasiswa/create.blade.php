            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        {{-- Tanggal Lahir --}}
                        <x-form-input type="date" name="tanggal_lahir" :value="$mahasiswa->tanggal_lahir?->format('Y-m-d') ?? null" id="inputTanggalLahir" label="Tanggal Lahir"
                            required />
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="alamat" role="tabpanel" aria-labelledby="alamat-tab">
                        <div class="row mt-3">
                            <div class="col-6">
                                ...
                                {{-- NISN --}}
                                <x-form-input name="nisn" :value="$mahasiswa->nisn ?? null" id="inputNisn" label="NISN" placeholder="Masukan NISN" />
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <x-form-input name="kelurahan" :value="$mahasiswa->kelurahan ?? null" id="inputKelurahan" label="Kelurahan"
                                            placeholder="Masukan Kelurahan" required />
                                    </div>
                                    <div class="col-4">
                                        <x-form-input name="kode_pos" :value="$mahasiswa->kode_pos ?? null" id="inputKodePos" label="Kode Pos"
                                ...
                                <x-form-select name="jenis_tinggal" :model="$mahasiswa" id="inputJenisTinggal" label="Jenis Tinggal"
                            ...
                            <div class="col-6">
                                {{-- NIK --}}
                                <x-form-input name="nik" :value="$mahasiswa->nik ?? null" id="inputNik" label="NIK" placeholder="Masukan NIK"
                                    required />

                                {{-- NPWP --}}
                                <x-form-input name="npwp" :value="$mahasiswa->npwp ?? null" id="inputNpwp" label="NPWP" placeholder="Masukan NPWP" />
                                ...
                                {{-- HP --}}
                                <x-form-input name="hp" :value="$mahasiswa->hp ?? null" id="inputHp" label="HP" placeholder="Contoh: 08xxxx"
                                 />
                                ...
                                <x-form-select name="penerima_kps" :model="$mahasiswa" id="inputPenerimaKps" label="Penerima KPS"
                                ...
                                <x-form-select name="alat_transportasi" :model="$mahasiswa" id="inputAlatTransportasi"
                                    label="Alat Transportasi" placeholder="Pilih Alat Transportasi"
                                    :options="$list_alat_transportasi
                    ...
                    <div class="tab-pane fade" id="orang-tua" role="tabpanel" aria-labelledby="orang-tua-tab">
                        <div class="row mt-3">
                            <div class="col-6">
                                <x-form-input name="nama_ayah" :value="$mahasiswa->nama_ayah ?? null" id="inputNamaAyah" label="Nama Ayah" placeholder="" />

                                <x-form-input name="nik_ayah" :value="$mahasiswa->nik_ayah ?? null" id="inputNikAyah" label="NIK Ayah" placeholder="" />
                                ...
                                <x-form-select name="pekerjaan_ayah" :model="$mahasiswa" id="inputPekerjaanAyah" label="Pekerjaan Ayah"
                                    placeholder="Pekerjaan" :options="$list_pekerjaan->pluck('nama_pekerjaan', 'id_pekerjaan')->toArray()" />

                                <x-form-select name="penghasilan_ayah" :model="$mahasiswa" id="inputPenghasilanAyah" label="Penghasilan Ayah"
                                    placeholder="Penghasilan" :options="$list_penghasilan
                                        ->pluck('nama_penghasilan', 'id_penghasilan')
                                        ->toArray()" />

                                <x-form-select name="pendidikan_ayah" :model="$mahasiswa" id="inputPendidikanAyah" label="Pendidikan Ayah"
                                    placeholder="Pendidikan" :options="[]" />

                            </div>
                            <div class="col-6">
                                <x-form-input name="nama_ibu_kandung" :value="$mahasiswa->nama_ibu_kandung ?? null" id="inputNamaibu" label="Nama Ibu"
                                    placeholder="" />

                                <x-form-input name="nik_ibu" :value="$mahasiswa->nik_ibu ?? null" id="inputNikibu" label="NIK Ibu" placeholder="" />
                                ...
                                <x-form-select name="pekerjaan_ibu" :model="$mahasiswa" id="inputPekerjaanIbu" label="Pekerjaan Ibu"
                                    placeholder="Pekerjaan" :options="$list_pekerjaan->pluck('nama_pekerjaan', 'id_pekerjaan')->toArray()" />

                                <x-form-select name="penghasilan_ibu" :model="$mahasiswa" id="inputPenghasilanIbu" label="Penghasilan Ibu"
                                    placeholder="Penghasilan" :options="$list_penghasilan
                                        ->pluck('nama_penghasilan', 'id_penghasilan')
                                        ->toArray()" />

                                <x-form-select name="pendidikan_ibu" :model="$mahasiswa" id="inputPendidikanIbu" label="Pendidikan Ibu"
                                    placeholder="Pendidikan" :options="[]" />
                            </div>
                        </div>
                    </div>
