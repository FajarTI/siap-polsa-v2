...
CREATE TABLE `jenis_tinggal` (
  `id_jenis_tinggal` int NOT NULL,
  `nama_jenis_tinggal` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `jenis_tinggal` VALUES (1,'Bersama orang tua'),(2,'Wali'),(3,'Kost'),(4,'Asrama'),(5,'Panti asuhan'),(10,'Rumah sendiri'),(99,'Lainnya');
...
-- Dump completed on 2025-08-16 13:30:30
